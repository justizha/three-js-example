...
const geometry = new THREE.RingGeometry( 5,3,7,10);
...
//planet
 const planetTexture = new THREE.TextureLoader().load('blue.jpg')
 ...
 function moveCamera() {
     ...
     camera.position.x = i * -0.0002;
     camera.position.y = i * -0.0002;
